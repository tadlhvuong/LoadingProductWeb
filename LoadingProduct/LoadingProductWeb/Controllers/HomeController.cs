...
namespace LoadingProductWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            ServiceDemo service1 = new ServiceDemo(1,
                                          "Bốc xếp hàng hóa",
            ...
            ServiceDemo service2 = new ServiceDemo(2,
            ...
            ServiceDemo service3 = new ServiceDemo(3,
                                        "Cho thuê nhân công",
            ...
            ServiceDemo service4 = new ServiceDemo(4,
            ...
            ServiceDemo[] services = { service1, service2, service3, service4 };
